...
annotation <- file.path(data_dir, "annotation_GMP-CLP.csv") 
data.source <- c(data_dir, annotation)

# Directory where the file is written
analysis.dir <- "~/Project_Analysis/analysis2.1.0"
...
# Writes the enhancer data to hard disk to avoid downloading track in subsequent
# analysis:
...
# This shows the region types that have been loaded:
